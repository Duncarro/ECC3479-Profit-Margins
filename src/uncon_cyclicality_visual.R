...
gop_gdp1 <- margin_bn_plot |>
  ...
  scale_colour_manual(
    values = c(
      "GOP Margin" = "#C05C55",   # charcoal black
      "BN Cycle"   = "#3B5B92"    # muted professional blue
    )
  ) +
  ...
  labs(
    title = "Unconditional Cyclicality of GOP Margin and GDP",
    subtitle = "Comparison of GOP and GDP Cyclical Compoents",
    x = NULL,
    y = "Percentage Deviation",
    colour = NULL,
    caption = "Source: ABS National Accounts | Author calculations"
...
ggsave(
  "output/Unconditional_cyclicality_gop.png",
  plot = gop_gdp1,
  width = 12,    
  height = 6,   
  dpi = 300
